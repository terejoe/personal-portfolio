...
export default function Project() {
  return (
    <div name ='projects' className='w-full pt-2 md:h-screen bg-[#010021] text-gray-300'>
      <div className='max-w-[1000px] mx-auto p-4 flex flex-col justify-center w-full h-full'>
        ...
        <div className='grid sm:grid-cols-2 md:grid-cols-3 gap-4 mx-auto'>
          ...
          <div className='border-lg shadow-lg shadow-black container rounded-md justify-center items-center max-w-sm overflow-hidden'>
            <a href=' https://eduford-schoolwebsite.netlify.app'><img src={school} alt='Website' className='w-full'/></a>
            <div className='px-6 py-4'>
              <p className='font-bold text-gray-500 text-xl mb-2'>School Website</p>
              <ul>
                <li><strong><a href='https://github.com/terejoe/School-website'className='hover:text-green-300'>View Code</a></strong></li>
                <li><strong><a href=' https://eduford-schoolwebsite.netlify.app' className='hover:text-green-300'>View Website</a></strong></li>
              </ul>
            </div>
          </div>
